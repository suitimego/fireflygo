...
type fireflygoRpc struct {
	conn           iface.IWriter
	asyncResultMgr *AsyncResultMgr
}

func NewfireflygoRpc(conn iface.IWriter) *fireflygoRpc {
	return &fireflygoRpc{
		conn:           conn,
...
func (this *fireflygoRpc) CallRpcNotForResult(target string, args ...interface{}) error {
	rpcdata := &RpcData{
...
func (this *fireflygoRpc) CallRpcForResult(target string, args ...interface{}) (*RpcData, error) {
