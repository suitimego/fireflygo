...
var (
	fireflygo_MONGODB_SESSION_NIL_ERR    = errors.New("DbOperate session nil.")
	fireflygo_MONGODB_NOTFOUND_ERR       = errors.New("not found!")
	fireflygo_MONGODB_DBFINDALL_ERR      = errors.New("DBFindAll failed,q is nil!")
	fireflygo_MONGODB_OPENGRIDFILE_ERR   = errors.New("OpenGridFile failed!")
	fireflygo_MONGODB_READGRIDFILE_ERR   = errors.New("ReadGridFile failed!")
	fireflygo_MONGODB_CREATEGRIDFILE_ERR = errors.New("CreateGridFile is nil")
)
...
func (this *DbOperate) Insert(collection string, doc interface{}) error {
	if this.session == nil {
		return fireflygo_MONGODB_SESSION_NIL_ERR
	}
...
func (this *DbOperate) DBFindAll(collection string, cond interface{}, resHandler func(bson.M) error) error {
	...
	if nil == q {
		return fireflygo_MONGODB_DBFINDALL_ERR
	}
...
func (this *DbOperate) DeleteAll(collection string, cond interface{}) (int, error) {
	if this.session == nil {
		return 0, fireflygo_MONGODB_SESSION_NIL_ERR
	}
...
func (this *DbOperate) OpenGridFile(collection string, filename string) ([]byte, error) {
	if this.session == nil {
		return nil, fireflygo_MONGODB_SESSION_NIL_ERR
	}
	...
	if fsfile == nil {
		return nil, fireflygo_MONGODB_OPENGRIDFILE_ERR
	}
	defer fsfile.Close()
	...
	if err != nil {
		return nil, fireflygo_MONGODB_READGRIDFILE_ERR
	}
	return data, nil
}
...
func (this *DbOperate) CreateGridFile(collection string, filename string, resHandler func(*mgo.GridFile) error) error {
	...
	if file == nil {
		return fireflygo_MONGODB_CREATEGRIDFILE_ERR
	}
	if resHandler != nil {
		err = resHandler(file)
		if err != nil {
...
func (this *DbOperate) GridFileExists(collection string, filename string) (bool, error) {
	if this.session == nil {
		return false, fireflygo_MONGODB_SESSION_NIL_ERR
	}
